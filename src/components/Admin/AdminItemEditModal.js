...
const AdminItemEditModal = ({itemInfo, onCancel, put_ItemInfo}) => {
    ...
    const [ itemDescription, setItemDescription ] = useState(itemInfo?.itemDescription);
    ...
    return(
        <div className="flex fixed top-0 right-0 left-0 bottom-0 w-[100vw] h-[100vh] z-99 bg-[rgba(0,0,0,0.6)] items-center">
            <div className="w-[50%] h-[70%] bg-white rounded-[1em] m-auto py-[2%]">
                <div className="items-center w-[10rem] h-[13rem] font-bold text-md m-auto">
                    <img className="w-[10rem] h-[10rem]" src={previewNewItemImg ? previewNewItemImg : itemInfo?.imgUrl} alt="ItemImg"/>
                    <form>
                ...
                <div className="flex items-center justify-center w-[70%] h-[15%] font-bold text-md m-auto">
                    <div className="flex w-[17.5%] h-[90%] items-center">
                        상품명
                    </div>
                    <input
                ...
                <div className="flex items-center justify-center w-[70%] h-[22.5%] font-bold text-md m-auto">
                    <div className="flex w-[17.5%] h-[90%] items-center">
                        상품 설명
                    </div>
                    <textarea
                ...
                <div className="flex w-[90%] h-[15%] m-auto items-center justify-end mt-2">
                    <div
